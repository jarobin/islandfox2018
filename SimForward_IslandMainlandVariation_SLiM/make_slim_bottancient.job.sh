# Script to make SLiM job script for Ancient Bottleneck model
...
// After burn-in, create island population of 10 individuals for Ancient Bottleneck model
${t} {
