# Script to make SLiM job script for Recent Bottleneck model
...
// Reduce island population to 10 individuals 30 generations ago for Recent Bottleneck
// model
$((${t} + 10000 - 30)) {
...
$((${t} + 10000 - 30)): {
	newSize_p2 = asInteger(round(2^(sim.generation - $((${t} + 10000 - 30))) * 10)) ; 
	if (newSize_p2 >= ${n}) { 
		newSize_p2 = ${n} ;
